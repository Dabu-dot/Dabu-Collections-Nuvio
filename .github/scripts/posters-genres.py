...
def get_trending_media_for_genre(genre_name, config, excluded_keys):
    ...
    for page in range(1, MAX_PAGES + 1):
        try:
            ...
            if "without_genres=" in tv_extra:
                tv_extra = tv_extra.replace("without_genres=", "without_genres=10764,")
            else:
    ...
    for item in combined:
        ...
        # VERROU PYTHON 2 : Double-sécurité anti-Télé-réalité sur le tableau d'IDs
...
def main():
    ...
    for genre_name, config in GENRES_CONFIG.items():
        ...
        for item in candidates:
            # SÉCURITÉ ANIMATION : Exclusion implacable de l'Asie hors de son genre dédié
            ...
            # FILTRE SÉCURITÉ FAMILLE RELIGION
        ...
        for candidate in scored_candidates:
            ...
            # FILTRE ANTI-REDONDANCE VISUELLE : Extraction des backdrops jamais affichés
